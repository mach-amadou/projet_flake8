...
<html>
   <head>
      <title>flake8 violations: CTM\env\lib\python3.10\site-packages\pip\_vendor\chardet\cli\__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="CTM.env.lib.python3.10.site-packages.pip._vendor.chardet.cli.__init__.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               CTM\env\lib\python3.10\site-packages\pip\_vendor\chardet\cli\__init__.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="CTM.env.lib.python3.10.site-packages.pip._vendor.chardet.cli.__init__.source.html#l1">
                  <tt><i>1</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
